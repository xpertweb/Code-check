...
class ButlerResetPassword {
  ...
  async patch(id, data) {
    try {
      ...
      if(passwordHased) {
        await this.knex('butlers').where('id', id).update({password: passwordHased});
...
module.exports = function (options) {
  return new ButlerResetPassword(options);
}
module.exports.Service = ButlerResetPassword;
