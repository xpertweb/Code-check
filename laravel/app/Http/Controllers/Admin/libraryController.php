...
class libraryController  extends Controller
{
    ...
    {		
		...
		if (!empty($request->post()))
		{
			...
			return redirect()->route('admin-files-list',$library_id)->with("success", "Library added successfully.");

		}	
		
        return view("admin.library.add",$data);
    }
	...
	public function filesList(Request $request){
		...
		return view("admin.library.filesList",$data);
	}
