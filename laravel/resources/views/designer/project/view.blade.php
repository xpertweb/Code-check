		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green-sharp bold uppercase">@lang('messages.Project') #{{$project->project_id}} </span>
					<span class="caption-helper">{{date('M d, Y H:i:s',strtotime($project->created_at))}}</span>
				</div>
				<div class="actions">
					<a href="{{ route('project-list') }}" class="btn btn-default btn-circle">
						<i class="fa fa-angle-left"></i>
						<span class="hidden-480">@lang('messages.back') </span>
					</a>
				</div>
			</div>
						...
						<div class="portlet yellow-crusta box">
							...
							<div class="portlet-body">
								...
								<div class="row static-info">
									...
									<div class="col-md-7 value">
										@if($project->project_link)
											<a href='{{$project->project_link}}' >@lang('messages.click_here')</a>
										@else
											Not Found
										@endif
									</div>
								...
								<div class="row static-info">
									...
									<div class="col-md-7 value">
										@if($project->project_status == 0) In progress @else Completed @endif
									</div>
								</div>	
								@if($project->project_status == 1)
								<div class="row static-info">
									<div class="col-md-5 name">@lang('messages.Project') @lang('messages.doc'):</div>
									<div class="col-md-7 value">
