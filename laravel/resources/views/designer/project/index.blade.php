		...
		<table class="table table-striped table-bordered table-hover" id="sample_2">
			...
			<tbody>
				...
				<tr>
					...
					@if($role_id == 3)
					<td><a onclick="return confirm('Are you sure you want to delete selected project ?')" href="{{ route('delete-project',$projects->project_id) }}" class="btn red"><i class="fa fa-trash"></i></a></td>
					@endif
				</tr>
				@endforeach
			</tbody>
