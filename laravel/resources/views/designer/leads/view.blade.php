	...
	<div class="col-md-12">
		...
		<div class="portlet light">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="{{ route('leads-list') }}" class="btn btn-default btn-circle">
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="portlet yellow-crusta box">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-cogs"></i>@lang('messages.lead_detail')
								</div>
							</div>
							<div class="portlet-body">
								...
								<div class="row static-info">
									<div class="col-md-5 name">@lang('messages.Lead') @lang('messages.name'):</div>
								...
								<div class="row static-info">
									...
									<div class="col-md-7 value">
										@if($leads->leads_link)
											<a target='_blank' href='{{$leads->leads_link}}' >@lang('messages.click_here')</a>
										@else
											Not Found
										@endif
									</div>
								...
								<div class="row static-info">
									...
									<div class="col-md-7 value">
										@if($leads->leads_type == 0) PhoneLead @else MailLead @endif
									</div>
								</div>
							</div>
						</div>
