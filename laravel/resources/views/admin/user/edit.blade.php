@extends('layouts.app')
@section('title', 'Rediger Designer')
@section('content')
	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="projectform" action="{{ route('admin-edit-user',$user->id) }}" method="post">
					{{ csrf_field() }}
					<div class="form-body">
						<div class="row">
							<div class="col-sm-6">
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<select name='is_lead_accept' class="form-control" >
										...
										<option @if($user->designer->is_lead_accept == 0) selected @endif value='0'>No</option>
										<option @if($user->designer->is_lead_accept == 1) selected @endif value='1'>Yes</option>
									</select>
								</div>
							</div>
						</div>
