				...
				<tr>
					...
					<td>
						@if($projects->project_status == 0)
							<a href="{{ route('admin-complete-project',$projects->project_id) }}" class="btn blue">Complete</a>
						@else
...
<script>
	var admin_project_status = "{{ route ('admin-project-status')}}";	
</script>
@stop