		...
		<table class="table table-striped table-bordered table-hover" id="sample_2">
			...
			<tbody>
				...
				<tr>
					...
					<td><a onclick="return confirm('Are you sure you want to delete selected admin ?')" href="{{ route('admin-delete-subadmin',$users->id) }}" class="btn red"><i class="fa fa-trash"></i></a></td>
				</tr>
				@endforeach
			</tbody>
		</table>
