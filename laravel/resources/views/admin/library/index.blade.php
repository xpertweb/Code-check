			...
			<tbody>
				@if($libraryCount != 0)
					...
					<tr>
						...
						<td><a class='btn btn-success' href="{{ route('admin-files-list',$librareis->library_id) }}"><i class='fa fa-eye'></i></a></td>
						<td><a class='btn btn-danger' onclick="return confirm('Are you sure you want to delete selected ?')" href="{{ route('admin-delete-library',$librareis->library_id) }}"><i class='fa fa-trash'></i></a></td>
					</tr>
					@endforeach
				@endif
			</tbody>
