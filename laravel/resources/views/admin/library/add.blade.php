...
<div class="portlet box blue-madison">
	...
	<div class="portlet-body form">
			...
			<form class="libraryform" action="{{ route('admin-add-library') }}" method="post" enctype='multipart/form-data'>
				{{ csrf_field() }}
				<div class="form-body">
					<div class="row">
						<div class="col-sm-6">
						...
						<!--div class="col-sm-6">
							<label>@lang('messages.designerName')</label>
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-sliders"></i></span>
								<select name='designer_id' class="form-control" required >
									...
									@foreach($designer as $designers)
										<option value="{{ $designers->id }}">{{ $designers->name }}</option>
									@endforeach
								</select>
							</div>
