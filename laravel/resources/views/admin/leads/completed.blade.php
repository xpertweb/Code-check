@extends('layouts.app')
@section('title', 'Fuldførte kundeemner')
@section('content')
@php
$i=1
@endphp
		...
		<table class="table table-striped table-bordered table-hover" id="sample_2">
			...
			<tbody>
				...
				<tr>
					...
					<td><a onclick="return confirm('Are you sure you want to delete selected project ?')" href="{{ route('admin-delete-leads',$lead->leads_id) }}" class="btn red"><i class="fa fa-trash"></i></a></td>
				</tr>
				@endforeach
			</tbody>
		</table>
