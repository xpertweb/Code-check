@extends('layouts.app')
@section('title', 'Rediger nye kundeemner')
@section('content')
					...
					<div class="col-sm-4 text-center" style="margin-top: 3px;">
						...
						<div class="col-sm-8">
							<select name="leads_type" class="form-control">
								<option @if($leads->leads_type == 0) selected  @endif value="0">Phone Lead</option>
								<option @if($leads->leads_type == 1) selected  @endif value="1">Mail Lead</option>
							</select>
						</div>
					</div>
					<div class="col-sm-4 text-center" style="margin-top: 3px;">
						<div class="col-sm-4" style="font-size: 20px;color: #000;">@lang('messages.name'):</div>
						<div class="col-sm-8">
							<select class="form-control" name="designer_id" aria-required="true" aria-describedby="select-error">
								...
								@foreach($user as $users)
									<option @if($leads->designer_id == $users->designer_id) selected  @endif value="{{$users->designer_id}}">{{$users->name}}</option>
								@endforeach
							</select>
						</div>
					</div>
						...
						<div class="row">	
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<input type="text" name='leads_name' class="form-control" value="{{$leads->leads_name}}" placeholder="@lang('messages.Lead') @lang('messages.name')">
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<input type="text" name='client_email' class="form-control" value="{{$leads->client_email}}" placeholder="@lang('messages.email')">
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<input type="text" name='client_phone' maxlength='12' class="form-control" value="{{$leads->client_phone}}" placeholder="@lang('messages.client_phone')">
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-sliders"></i></span>
									<input type="text" name='client_vat' class="form-control" value="{{$leads->client_vat}}" placeholder="@lang('messages.client_vat')">
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<input type="text" name='client_address' class="form-control" value="{{$leads->client_address}}" placeholder="@lang('messages.address')">
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<input type="text" name='client_person' class="form-control" value="{{$leads->client_person}}" placeholder="@lang('messages.client_person')">
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="input-group">
									...
									<input type="text" name='leads_link' class="form-control" value="{{$leads->leads_link}}" placeholder="@lang('messages.lead_link')">
								</div>
